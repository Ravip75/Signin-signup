...
function userRegisterReducer(state={data: []},action){
    switch (action.type){
...
function userDetailReducer(state={data: []},action){
    switch (action.type){
...
export{
    userSigninReducer,userRegisterReducer,userListReducer,userDetailReducer,userSaveReducer
}